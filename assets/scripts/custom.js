...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function init_template() {
    ...
    if (iosVer.version > 14 && document.querySelectorAll("#page")[0]) {
    ...
    if (isMobile.iOS() && document.querySelectorAll("#page")[0]) {
    ...
    if (isMobile.Android() && document.querySelectorAll("#page")[0]) {
